    ...
    for choice = [0,1,2]
        ...
        for c = [4,8] % Never chose an odd number!
            ...
            for a1 = a1s
                ...
                writematrix(a1,filename,'Sheet',sheet,'Range','I'+string(i));
